...
const Faq = () => {
    return (
        <div style={{ backgroundColor: '#BB9981' }}>
            <div className="m-2 container mx-auto" style={{ fontFamily: "raleway" }}>
                <br />
                <div>
                    <h1 className="my-3 text-center" style={{ color: '#534340' }}>Frequently Asked Questions</h1>
                </div>
                <br />
                <div>
                    ...
                    <Accordion>
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton style={{ backgroundColor: '#F4FCD9', color: "#534340" }}>
                                    WHAT IS THE BEST TREADMILL FOR HOME USE?
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel style={{ backgroundColor: '#CFD8A4' }}>
                                <p >
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton style={{ backgroundColor: '#F4FCD9', color: "#534340" }}>
                                    HOW DO YOU PICK A TREADMILL FOR HOME USE?
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel style={{ backgroundColor: '#CFD8A4' }}>
                                <p>
                        ...
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton style={{ backgroundColor: '#F4FCD9', color: "#534340" }}>
                                    WHY DO TREADMILLS USE “MPH” WHEN RUNNERS PREFER MINUTES PER MILE?
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel style={{ backgroundColor: '#CFD8A4' }}>
                                <p>
